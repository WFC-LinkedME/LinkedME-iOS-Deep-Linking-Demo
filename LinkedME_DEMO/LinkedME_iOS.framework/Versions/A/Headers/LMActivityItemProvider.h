//
//  LMActivityItemProvider.h
//  iOS-Deep-Linking-SDK
//
//  Created by han on 1/28/15.
...
/**
 The `LKMEActivityItemProviderDelegate` allows you  to customize the link parameters based on the channel chosen by the user.
 ...
 */
@protocol LKMEActivityItemProviderDelegate <NSObject>
...
@interface LMActivityItemProvider : UIActivityItemProvider
...
- (id)initWithParams:(NSDictionary *)params tags:(NSArray *)tags feature:(NSString *)feature stage:(NSString *)stage alias:(NSString *)alias delegate:(id <LKMEActivityItemProviderDelegate>)delegate;
